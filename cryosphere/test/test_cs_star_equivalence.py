...
class TestCsStarEquivalenceCTF(unittest.TestCase):
	...
	"""
	def setUp(self):
		self.ctf_star = CTF.create_ctf("test_apoferritin/particles/particles.star", device="cpu", apix_downsize = 1.428, Npix_downsize = 256)
		self.ctf_cs = CTF.create_ctf("test_apoferritin/J25_split_0_exported.cs", device="cpu", apix_downsize = 1.428, Npix_downsize = 256)
